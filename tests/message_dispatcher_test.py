...
def test_message_extra_0365():
    ...
    assert slack_text == "Here is your update from the Azure NSG Watcher:\n\nNo O365 NSG rules are missing\nNo GSUITE NSG rules are missing\nThese port 25 SMTP NSG rules for O365 Exchange are no longer needed:\n\n\t- 201.168.12.1/24\nThese port 25 SMTP NSG rules for GSUITE Gmail are no longer needed:\n\n\t- 200.168.3.1/24"
...
def test_missing_o365_message():
    ...
    assert slack_text == "Here is your update from the Azure NSG Watcher:\n\nThese port 25 SMTP Ingress NSG rules are missing for O365 Exchange:\n\n\t- 202.168.3.1/24\nNo GSUITE NSG rules are missing"
...
def test_missing_gsuite_message():
    ...
    assert slack_text == "Here is your update from the Azure NSG Watcher:\n\nNo O365 NSG rules are missing\nThese port 25 SMTP Ingress NSG rules are missing for GSUITE Gmail:\n\n\t- 201.168.3.1/24"
