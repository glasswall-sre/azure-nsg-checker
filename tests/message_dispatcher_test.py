...
def test_message_extra_gsuite():
    ...
    assert slack_text == "No O365 NSG rules are missing\nNo GSUITE NSG rules are missing\nThese NSG rules for GSUITE are no longer needed:\n\t - 200.168.3.1/24"
...
def test_message_extra_0365():
    ...
    assert slack_text == "No O365 NSG rules are missing\nNo GSUITE NSG rules are missing\nThese NSG rules for O365 are no longer needed:\n\t - 201.168.12.1/24\nThese NSG rules for GSUITE are no longer needed:\n\t - 200.168.3.1/24"
...
def test_missing_o365_message():
    ...
    assert slack_text == "The following NSG rules are missing from O365:\n\t- 202.168.3.1/24\nNo GSUITE NSG rules are missing"
...
def test_missing_gsuite_message():
    ...
    assert slack_text == "No O365 NSG rules are missing\nThe following NSG rules are missing from GSUITE:\n\t- 201.168.3.1/24"
